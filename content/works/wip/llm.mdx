...
<UpdatedSpan text="[updated] 最后更新于 2025-02-18" />
...
- 【ReAct，将推理和行动结合起来的 Agent 设计思路范式，但伴随推理模型和LLM本身能力的增强，这个范式不一定好用了】[ReAct: Synergizing Reasoning and Acting in Language Models](https://arxiv.org/abs/2210.03629)
