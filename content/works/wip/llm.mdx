...
- 【Reasoning Models Don't Always Say What They Think】[https://arxiv.org/abs/2505.05410](https://arxiv.org/abs/2505.05410)

总结便是：**对于未在模型训练时对齐的范式的任务，推理模型相应的思考可能并不靠谱。** 这个比例大概在 20% 。
对于不正确的推理，往往相应的推理思考过程更加冗长且复杂，往往包含针对事实的不正确答案。即错误推理具备这样的特征。
