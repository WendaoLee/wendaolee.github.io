      ...
      <div className=" w-full">
        <div className="mt-[5%] text-base flex flex-col leading-normal">
          ...
          <section className="mb-[20px] w-full">
            ...
            <br />
            <br />
            “恍若惊鸿怜客眼，倏如飘雨冷青衫”——如果拿一句诗自述平生的话，我可能会用这句我过去写的诗。
            <br />
            <br />
            如果拿别人的诗来评价，应该是“苔痕深院雨，人影小窗灯”。
            <br />
            <br />
            目前就职于AI创业公司，司职技术总监。
            <br />
            <br />
            这里是李问道的博客站点。主要用来存放我过去的文稿（是的，找个地方放东西，像是杂货堆那样）。
            <br />
            <br />
            ...
            <br />
            这个博客站点还在缓慢更新中。你可以点击右上角的搜索按钮通过模糊搜索搜索你感兴趣的内容✨~
            <br />
            想要与我联系可以在下方找到联系方式😉。
            <br />
          </section>
